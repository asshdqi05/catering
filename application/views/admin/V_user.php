...
<div class="modal fade" id="modal_add">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="POST" action="<?php echo site_url('C_user/add') ?>">
...
<div class="modal fade" id="edit_data">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="POST" action="<?php echo site_url('C_user/edit') ?>">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama user</label>
...
<div class="modal fade" id="hapus_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo site_url('C_user/delete') ?>">
                <div class="modal-body">
